...
enum SettingsTextIndex { SET_OTAURL,
                         ...
                         SET_HFEM_METADATA_NAME, SET_HFEM_METADATA_MODEL, SET_HFEM_METADATA_MANUFACTURER, SET_HFEM_METADATA_DESCRIPTION, SET_HFEM_METADATA_CATEGORY, SET_HFEM_METADATA_LOCATION,
                         SET_MAX };
