...
enum SettingsTextIndex { SET_OTAURL,
                         ...
                         SET_HF_ENERGY_METADATA_NAME, SET_HF_ENERGY_METADATA_MODEL, SET_HF_ENERGY_METADATA_MANUFACTURER, SET_HF_ENERGY_METADATA_DESCRIPTION, SET_HF_ENERGY_METADATA_LOCATION,
                         SET_MAX };
